...
<div id="subnavbar">
	...
	<span id="pages"><?=anchor('about', 'About'); ?> &middot; <?=anchor('subscribe', 'Subscribe'); ?> &middot; <?=anchor('advertise', 'Advertise'); ?> &middot; <?=anchor('contact', 'Contact'); ?> &middot; <span id="submittip">Submit a tip</span></span>
</div>
